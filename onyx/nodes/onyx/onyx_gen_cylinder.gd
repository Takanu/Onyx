...
export(int) var sides = 12
export(int) var rings = 1

# The height values for the top and bottom of the cylinder.
export(float) var height_max = 1
export(float) var height_min = 0

export(float) var x_width = 0.5
export(float) var z_width = 0.5

# If true, the X and Z width will always equal each other.
export(bool) var keep_width_proportional = false
