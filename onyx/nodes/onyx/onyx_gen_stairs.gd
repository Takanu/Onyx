...
func build_control_points():
	...
	active_controls[start_position.control_name] = start_position
	active_controls[end_position.control_name] = end_position
	active_controls[stair_width.control_name] = stair_width
...
func refresh_control_data():
	...
	active_controls["stair_width"].control_position = start_position + depth_mid + width_mid
...
func apply_control_attributes():
	...
	stair_width = (active_controls["stair_width"].control_position.x - start_position.x) * 2
